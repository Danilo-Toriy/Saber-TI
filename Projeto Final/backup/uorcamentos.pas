...
begin
    ...
    DataModule1.qryGenerica.ParamByName('id').AsInteger := id_orcamento;
    DataModule1.qryGenerica.Open;

   if not DataModule1.qryGenerica.FieldByName('soma').IsNull then
   begin
       DataModule1.zqryOrcamentos.Edit;
       DataModule1.zqryOrcamentosvl_total_orcamento.AsFloat := DataModule1.qryGenerica.FieldByName('soma').AsFloat;
